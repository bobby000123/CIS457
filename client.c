/*
	...
	Description : This program comes paired with a server
	> program which facilitates the connection between one
	> or multiple users of a peer-to-peer based chatroom. This
	> program is the client-side (user) which operates the chat
	> functionality.
